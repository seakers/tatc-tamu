 ...
 * @author Prachi
 */
public class Operator extends AbstractTATCOperator {
    ...
    public Operator(boolean negate, int decision, double level) {
        this.negate = negate;
    ...
    public String toString() {
        ...
        if (!this.negate) {
            operatorName = "Operator{" + String.format("Operator{ %d = %f }", this.decision, this.level);
        } else {
            operatorName = "Operator{" + String.format("Operator{ %d != %f }", this.decision, this.level);
        }
        return operatorName;
