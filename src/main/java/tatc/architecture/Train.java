...
public class Train implements ArchitectureMethods {
     ...
     */
    public Train(double semiMajorAxis, int dayLaunch, int monthLaunch, int yearLaunch, ArrayList<Double> LTANs, AbsoluteDate startDate, ProblemProperties props) throws OrekitException {
    ...
    public Train(double semiMajorAxis, ArrayList<Double> LTANs, AbsoluteDate startDate, ProblemProperties props) throws OrekitException {
        this.properties = props;
        final double inc = Orbits.incSSO(semiMajorAxis - Constants.WGS84_EARTH_EQUATORIAL_RADIUS);
        this.orbits = new ArrayList<>(LTANs.size());
