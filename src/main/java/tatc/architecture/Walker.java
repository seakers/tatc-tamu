 ...
 * @author Prachi
 */
public class Walker implements ArchitectureMethods{
     ...
     */
    public Walker(double semimajoraxis, double inc, int t, int p, int f, Satellite satellite, GroundNetwork groundNetwork, ProblemProperties props) {
